...
class TestForum(unittest.TestCase):
    ...
    def test_delete_post(self):
        ...
        self.assertEqual(total_posts_before - 1, total_posts_after, f"total posts did not decease by 1 after deletion - before: {total_posts_before}; after: {total_posts_after}")
    ...
    def test_create_post(self):
        ...
        self.assertEqual(total_posts_before + 1, total_posts_after, f"total posts did not increase by 1 after new post - before: {total_posts_before}; after: {total_posts_after}")
    ...
    def test_sort_by_posts_titles(self):
        ...
        self.assertEqual(all_posts_titles_text, all_posts_titles_text_sorted, f"Failed to sort by title!")
    ...
    def test_sort_by_posters_names(self):
        ...
        self.assertEqual(all_posters_names_text, all_posters_names_text_sorted, f"Failed to sort by poster name!")
    ...
    def test_sort_by_newest_post_first(self):
        ...
        self.assertEqual(all_poster_dates_text, all_poster_dates_text_sorted, f"Failed to sort by newest post!")
    ...
    def test_sort_by_oldest_post_first(self):
        ...
        self.assertEqual(all_poster_dates_text, all_poster_dates_text_sorted, "Failed to sort by oldest post!")
